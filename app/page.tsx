    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 space-y-12 md:space-y-20" dir="rtl">
      ...
      <section className="pb-12 md:pb-20">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-10 border-b border-slate-100 pb-6 gap-4">
          ...
          <button className="text-orange-600 font-bold hover:underline self-end md:self-auto">عرض الكل ←</button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
          {recipes && recipes.length > 0 ? (
            ...
            <div className="col-span-full py-16 md:py-20 text-center bg-slate-50 rounded-[2rem] md:rounded-[3rem] border-2 border-dashed border-slate-200">
              <h3 className="text-lg md:text-xl font-bold text-slate-800 px-4">نعمل على إضافة المزيد من الأطباق..</h3>
            </div>
          )}
        </div>
      </section>
